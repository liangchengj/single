...
{
    return jclz_callobjmtd(env, jclz, "<init>", sig, ...);
}
...
{
    return jclz_callctor(env, fdjclz("java/lang/Byte"), "(B)V", jbt);
}

inline jobject jshort_(JNIEnv *env, jshort jsh)
{
    return jclz_callctor(env, fdjclz("java/lang/Short"), "(S)V", jsh);
}

inline jobject jint_(JNIEnv *env, jint ji)
{
    return jclz_callctor(env, fdjclz("java/lang/Integer"), "(I)V", ji);
}

inline jobject jlong_(JNIEnv *env, jlong jl)
{
    return jclz_callctor(env, fdjclz("java/lang/Long"), "(J)V", jl);
}

inline jobject jfloat_(JNIEnv *env, jfloat jf)
{
    return jclz_callctor(env, fdjclz("java/lang/Float"), "(F)V", jf);
}

inline jobject jdouble_(JNIEnv *env, jdouble jd)
{
    return jclz_callctor(env,fdjclz("java/lang/Double"）,"(D)V",jd);
}

inline jobject jboolean_(JNIEnv *env, jboolean jbool)
{
    return jclz_callctor(env, fdjclz("java/lang/Boolean"), "(Z)V", jbool);
}

inline jobject jchar_(JNIEnv *env, jchar jch)
{
    return jclz_callctor(env, fdjclz("java/lang/Character"), "(C)V", jch);
}
...
inline jobject boxing(JNIEnv *env, char const *wrapper_name, ...)
{
    ...
    return jclz_callsticmtd(env, fdjclz(clzn),"valueOf");
}
...
inline void toast_show(JNIEnv *env, jobject ctx, jobject jobj, jint duration)
{
    ...
    jobject jobj_Toast = (*env)->CallStaticObjectMethod(env, jclz_Toast, jmid_makeText,
                                                        ctx,
                                                        param_sign == "I" ? (jint)jobj : jobj_tostr(env, jobj),
                                                        duration);
