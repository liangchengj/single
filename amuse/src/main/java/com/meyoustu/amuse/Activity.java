...
public abstract class Activity extends FragmentActivity {
  ...
  private void initResMemberByAnnotation() throws IllegalAccessException {
  ...
  private void initSysBarByAnnotation() throws IllegalAccessException {
  ...
  protected final @Dimension int getDimensionPixelSize(int id) {
