...
public final class Dialog extends android.app.Dialog {
  ...
  /**
   * When using a custom Dialog, there will be a blue line at the top of the dialog displayed on
   * some Android devices, use this method to eliminate it
   */
  ...
  private final class View extends android.view.View implements android.view.View.OnTouchListener {
    ...
    private float radius, maxWidth, maxHeight, line, middle, textSizeOnMessage, textSizeOnButton;
    ...
    protected void onDraw(Canvas canvas) {
      ...
      if (isNight()) {
        ...
        paint.setARGB(
            245, VALUE_MONOCHROME_MAXIMUM, VALUE_MONOCHROME_MAXIMUM, VALUE_MONOCHROME_MAXIMUM);
      }
